...
namespace LibraryManagementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\bachb\OneDrive\Documents\langkiu.mdf;Integrated Security=True;Connect Timeout=30");
            ...
            else
            {
                if(connect.State == ConnectionState.Closed)
                {
                    try
                    {
                        ...
                        string path = Path.Combine(@"C:\Users\bachb\OneDrive\Desktop\Library-Management-System-using-CSharp-main\LibraryManagementSystem\LibraryManagementSystem\Picture_Import\" +
